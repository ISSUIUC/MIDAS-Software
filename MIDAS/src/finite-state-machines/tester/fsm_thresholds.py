...
SUSTAINER_IGNITION_TO_SECOND_BOOST_ACCELERATION_THRESHOLD = 4
...
SUSTAINER_MAIN_DEPLOY_ALTITUDE_THRESHOLD = 975
...
SUSTAINER_LANDED_VERTICAL_SPEED_THRESHOLD = 4
...
BOOSTER_MAIN_DEPLOY_ALTITUDE_THRESHOLD = 999999
...
# Return state to FIRST_BOOST if not in BURNOUT for this amount of time (ms)
BOOSTER_FIRST_BOOST_TO_BURNOUT_TIME_THRESHOLD = 1500

# Transition to LANDED from MAIN if vertical speed is less than this threshold (m/s)
BOOSTER_LANDED_VERTICAL_SPEED_THRESHOLD = 4
