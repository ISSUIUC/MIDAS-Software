 ...
 *
 */
void KF::initialize(RocketSystems *args)
{
...
void KF::priori(float dt, Orientation &orientation, FSMState fsm, Acceleration acceleration)
{
    setF(dt);
    setB(dt);
 ...
 *
 */
void KF::update(Barometer barometer, Acceleration acceleration, Orientation orientation, FSMState FSM_state, GPS &gps)
{
 ...
 */
void KF::tick(float dt, float sd, Barometer &barometer, Acceleration acceleration, Orientation &orientation, FSMState FSM_state, GPS &gps)
{
 ...
 */
void KF::setState(KalmanState state)
{
 ...
 */
void KF::setQ(float dt, float sd)
{
...
void KF::reference_GPS(GPS &gps, FSMState fsm)
{
