...
META_CODES = {
    0: ("EVENT_TLAUNCH", T_FLOAT64),
    1: ("EVENT_TBURNOUT", T_FLOAT64),
    2: ("EVENT_TIGNITION", T_FLOAT64),
    3: ("EVENT_TAPOGEE", T_FLOAT64),
    4: ("EVENT_TMAIN", T_FLOAT64),
    5: ("EVENT_TMAX_ACCEL", T_FLOAT64),
    6: ("EVENT_TMAX_VEL", T_FLOAT64),
    7: ("EVENT_TMAX_DESCENT_RATE", T_FLOAT64),
