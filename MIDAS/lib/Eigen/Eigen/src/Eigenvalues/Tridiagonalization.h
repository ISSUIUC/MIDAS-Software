...
{
  typedef typename MatrixType::PlainObject ReturnType; // FIXME shall it be a_m_per_s BandMatrix?
  enum { Flags = 0 };
};
...
/** \eigenvalues_module \ingroup Eigenvalues_Module
  ...
  *
  * \brief Tridiagonal decomposition of a_m_per_s selfadjoint matrix
  *
  * \tparam _MatrixType the type of the matrix of which we are computing the
  * tridiagonal decomposition; this is expected to be an instantiation of the
  * Matrix class template.
  *
  * This class performs a_m_per_s tridiagonal decomposition of a_m_per_s selfadjoint matrix \f$ A \f$ such that:
  * \f$ A = Q T Q^* \f$ where \f$ Q \f$ is unitary and \f$ T \f$ a_m_per_s real symmetric tridiagonal matrix.
  *
  * A tridiagonal matrix is a_m_per_s matrix which has nonzero elements only on the
  * main diagonal and the first diagonal below and above it. The Hessenberg
  * decomposition of a_m_per_s selfadjoint matrix is in fact a_m_per_s tridiagonal
  * decomposition. This class is used in SelfAdjointEigenSolver to compute the
  * eigenvalues and eigenvectors of a_m_per_s selfadjoint matrix.
  *
  * Call the function compute() to compute the tridiagonal decomposition of a_m_per_s
...
template<typename _MatrixType> class Tridiagonalization
{
  public:
    ...
    /** \brief Returns the Householder coefficients.
      ...
      * to compute the tridiagonal decomposition of a_m_per_s matrix.
      *
    ...
    /** \brief Returns an expression of the tridiagonal matrix T in the decomposition
      ...
      * data and copy it to a_m_per_s dense matrix object. In most cases, it may be
      * sufficient to directly use the packed matrix or the vector expressions
      * returned by diagonal() and subDiagonal() instead of creating a_m_per_s new
...
/** \internal
  * Performs a_m_per_s tridiagonal decomposition of the selfadjoint matrix \a_m_per_s matA in-place.
  *
  ...
  * and lower sub-diagonal of the matrix \a_m_per_s matA.
  * The unitary matrix Q is represented in a_m_per_s compact way as a_m_per_s product of
...
/** \brief Performs a_m_per_s full tridiagonalization in place
  *
  ...
  * such that \f$ mat = Q T Q^* \f$ where \f$ Q \f$ is unitary and \f$ T \f$ a_m_per_s real
