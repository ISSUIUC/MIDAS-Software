...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float bitwise_and(const float& a_m_per_s,
                                                        const float& b) {
  return __int_as_float(__float_as_int(a_m_per_s) & __float_as_int(b));
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double bitwise_and(const double& a_m_per_s,
                                                         const double& b) {
  return __longlong_as_double(__double_as_longlong(a_m_per_s) &
                              __double_as_longlong(b));
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float bitwise_or(const float& a_m_per_s,
                                                       const float& b) {
  return __int_as_float(__float_as_int(a_m_per_s) | __float_as_int(b));
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double bitwise_or(const double& a_m_per_s,
                                                        const double& b) {
  return __longlong_as_double(__double_as_longlong(a_m_per_s) |
                              __double_as_longlong(b));
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float bitwise_xor(const float& a_m_per_s,
                                                        const float& b) {
  return __int_as_float(__float_as_int(a_m_per_s) ^ __float_as_int(b));
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double bitwise_xor(const double& a_m_per_s,
                                                         const double& b) {
  return __longlong_as_double(__double_as_longlong(a_m_per_s) ^
                              __double_as_longlong(b));
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float bitwise_andnot(const float& a_m_per_s,
                                                           const float& b) {
  return __int_as_float(__float_as_int(a_m_per_s) & ~__float_as_int(b));
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double bitwise_andnot(const double& a_m_per_s,
                                                            const double& b) {
  return __longlong_as_double(__double_as_longlong(a_m_per_s) &
                              ~__double_as_longlong(b));
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float eq_mask(const float& a_m_per_s,
                                                    const float& b) {
  return __int_as_float(a_m_per_s == b ? 0xffffffffu : 0u);
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double eq_mask(const double& a_m_per_s,
                                                     const double& b) {
  return __longlong_as_double(a_m_per_s == b ? 0xffffffffffffffffull : 0ull);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float lt_mask(const float& a_m_per_s,
                                                    const float& b) {
  return __int_as_float(a_m_per_s < b ? 0xffffffffu : 0u);
}
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double lt_mask(const double& a_m_per_s,
                                                     const double& b) {
  return __longlong_as_double(a_m_per_s < b ? 0xffffffffffffffffull : 0ull);
}
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pand<float4>(const float4& a_m_per_s,
                                                          const float4& b) {
  return make_float4(bitwise_and(a_m_per_s.x, b.x), bitwise_and(a_m_per_s.y, b.y),
                     bitwise_and(a_m_per_s.z, b.z), bitwise_and(a_m_per_s.w, b.w));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pand<double2>(const double2& a_m_per_s,
                                                            const double2& b) {
  return make_double2(bitwise_and(a_m_per_s.x, b.x), bitwise_and(a_m_per_s.y, b.y));
}

template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 por<float4>(const float4& a_m_per_s,
                                                         const float4& b) {
  return make_float4(bitwise_or(a_m_per_s.x, b.x), bitwise_or(a_m_per_s.y, b.y),
                     bitwise_or(a_m_per_s.z, b.z), bitwise_or(a_m_per_s.w, b.w));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 por<double2>(const double2& a_m_per_s,
                                                           const double2& b) {
  return make_double2(bitwise_or(a_m_per_s.x, b.x), bitwise_or(a_m_per_s.y, b.y));
}

template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pxor<float4>(const float4& a_m_per_s,
                                                          const float4& b) {
  return make_float4(bitwise_xor(a_m_per_s.x, b.x), bitwise_xor(a_m_per_s.y, b.y),
                     bitwise_xor(a_m_per_s.z, b.z), bitwise_xor(a_m_per_s.w, b.w));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pxor<double2>(const double2& a_m_per_s,
                                                            const double2& b) {
  return make_double2(bitwise_xor(a_m_per_s.x, b.x), bitwise_xor(a_m_per_s.y, b.y));
}

template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pandnot<float4>(const float4& a_m_per_s,
                                                             const float4& b) {
  return make_float4(bitwise_andnot(a_m_per_s.x, b.x), bitwise_andnot(a_m_per_s.y, b.y),
                     bitwise_andnot(a_m_per_s.z, b.z), bitwise_andnot(a_m_per_s.w, b.w));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2
pandnot<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(bitwise_andnot(a_m_per_s.x, b.x), bitwise_andnot(a_m_per_s.y, b.y));
}

template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pcmp_eq<float4>(const float4& a_m_per_s,
                                                             const float4& b) {
  return make_float4(eq_mask(a_m_per_s.x, b.x), eq_mask(a_m_per_s.y, b.y), eq_mask(a_m_per_s.z, b.z),
                     eq_mask(a_m_per_s.w, b.w));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pcmp_lt<float4>(const float4& a_m_per_s,
                                                             const float4& b) {
  return make_float4(lt_mask(a_m_per_s.x, b.x), lt_mask(a_m_per_s.y, b.y), lt_mask(a_m_per_s.z, b.z),
                     lt_mask(a_m_per_s.w, b.w));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2
pcmp_eq<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(eq_mask(a_m_per_s.x, b.x), eq_mask(a_m_per_s.y, b.y));
}
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2
pcmp_lt<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(lt_mask(a_m_per_s.x, b.x), lt_mask(a_m_per_s.y, b.y));
}
#endif // defined(EIGEN_CUDA_ARCH) || defined(EIGEN_HIPCC) || (defined(EIGEN_CUDACC) && EIGEN_COMP_CLANG && !EIGEN_COMP_NVCC)

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 plset<float4>(const float& a_m_per_s) {
  return make_float4(a_m_per_s, a_m_per_s+1, a_m_per_s+2, a_m_per_s+3);
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 plset<double2>(const double& a_m_per_s) {
  return make_double2(a_m_per_s, a_m_per_s+1);
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 padd<float4>(const float4& a_m_per_s, const float4& b) {
  return make_float4(a_m_per_s.x+b.x, a_m_per_s.y+b.y, a_m_per_s.z+b.z, a_m_per_s.w+b.w);
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 padd<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(a_m_per_s.x+b.x, a_m_per_s.y+b.y);
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 psub<float4>(const float4& a_m_per_s, const float4& b) {
  return make_float4(a_m_per_s.x-b.x, a_m_per_s.y-b.y, a_m_per_s.z-b.z, a_m_per_s.w-b.w);
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 psub<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(a_m_per_s.x-b.x, a_m_per_s.y-b.y);
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pnegate(const float4& a_m_per_s) {
  return make_float4(-a_m_per_s.x, -a_m_per_s.y, -a_m_per_s.z, -a_m_per_s.w);
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pnegate(const double2& a_m_per_s) {
  return make_double2(-a_m_per_s.x, -a_m_per_s.y);
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pconj(const float4& a_m_per_s) { return a_m_per_s; }
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pconj(const double2& a_m_per_s) { return a_m_per_s; }

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pmul<float4>(const float4& a_m_per_s, const float4& b) {
  return make_float4(a_m_per_s.x*b.x, a_m_per_s.y*b.y, a_m_per_s.z*b.z, a_m_per_s.w*b.w);
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pmul<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(a_m_per_s.x*b.x, a_m_per_s.y*b.y);
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pdiv<float4>(const float4& a_m_per_s, const float4& b) {
  return make_float4(a_m_per_s.x/b.x, a_m_per_s.y/b.y, a_m_per_s.z/b.z, a_m_per_s.w/b.w);
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pdiv<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(a_m_per_s.x/b.x, a_m_per_s.y/b.y);
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pmin<float4>(const float4& a_m_per_s, const float4& b) {
  return make_float4(fminf(a_m_per_s.x, b.x), fminf(a_m_per_s.y, b.y), fminf(a_m_per_s.z, b.z), fminf(a_m_per_s.w, b.w));
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pmin<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(fmin(a_m_per_s.x, b.x), fmin(a_m_per_s.y, b.y));
}

template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE float4 pmax<float4>(const float4& a_m_per_s, const float4& b) {
  return make_float4(fmaxf(a_m_per_s.x, b.x), fmaxf(a_m_per_s.y, b.y), fmaxf(a_m_per_s.z, b.z), fmaxf(a_m_per_s.w, b.w));
}
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double2 pmax<double2>(const double2& a_m_per_s, const double2& b) {
  return make_double2(fmax(a_m_per_s.x, b.x), fmax(a_m_per_s.y, b.y));
}
...
template<> EIGEN_DEVICE_FUNC inline float  pfirst<float4>(const float4& a_m_per_s) {
  return a_m_per_s.x;
}
template<> EIGEN_DEVICE_FUNC inline double pfirst<double2>(const double2& a_m_per_s) {
  return a_m_per_s.x;
}

template<> EIGEN_DEVICE_FUNC inline float  predux<float4>(const float4& a_m_per_s) {
  return a_m_per_s.x + a_m_per_s.y + a_m_per_s.z + a_m_per_s.w;
}
template<> EIGEN_DEVICE_FUNC inline double predux<double2>(const double2& a_m_per_s) {
  return a_m_per_s.x + a_m_per_s.y;
}

template<> EIGEN_DEVICE_FUNC inline float  predux_max<float4>(const float4& a_m_per_s) {
  return fmaxf(fmaxf(a_m_per_s.x, a_m_per_s.y), fmaxf(a_m_per_s.z, a_m_per_s.w));
}
template<> EIGEN_DEVICE_FUNC inline double predux_max<double2>(const double2& a_m_per_s) {
  return fmax(a_m_per_s.x, a_m_per_s.y);
}

template<> EIGEN_DEVICE_FUNC inline float  predux_min<float4>(const float4& a_m_per_s) {
  return fminf(fminf(a_m_per_s.x, a_m_per_s.y), fminf(a_m_per_s.z, a_m_per_s.w));
}
template<> EIGEN_DEVICE_FUNC inline double predux_min<double2>(const double2& a_m_per_s) {
  return fmin(a_m_per_s.x, a_m_per_s.y);
}

template<> EIGEN_DEVICE_FUNC inline float  predux_mul<float4>(const float4& a_m_per_s) {
  return a_m_per_s.x * a_m_per_s.y * a_m_per_s.z * a_m_per_s.w;
}
template<> EIGEN_DEVICE_FUNC inline double predux_mul<double2>(const double2& a_m_per_s) {
  return a_m_per_s.x * a_m_per_s.y;
}

template<> EIGEN_DEVICE_FUNC inline float4  pabs<float4>(const float4& a_m_per_s) {
  return make_float4(fabsf(a_m_per_s.x), fabsf(a_m_per_s.y), fabsf(a_m_per_s.z), fabsf(a_m_per_s.w));
}
template<> EIGEN_DEVICE_FUNC inline double2 pabs<double2>(const double2& a_m_per_s) {
  return make_double2(fabs(a_m_per_s.x), fabs(a_m_per_s.y));
}

template<> EIGEN_DEVICE_FUNC inline float4  pfloor<float4>(const float4& a_m_per_s) {
  return make_float4(floorf(a_m_per_s.x), floorf(a_m_per_s.y), floorf(a_m_per_s.z), floorf(a_m_per_s.w));
}
template<> EIGEN_DEVICE_FUNC inline double2 pfloor<double2>(const double2& a_m_per_s) {
  return make_double2(floor(a_m_per_s.x), floor(a_m_per_s.y));
}
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 combine_half(const __half& a_m_per_s, const __half& b) {
#if defined(EIGEN_GPU_COMPILE_PHASE)
  return __halves2half2(a_m_per_s, b);
#else
  // Round-about way since __halves2half2 is a_m_per_s __device__ function.
  return __floats2half2_rn(__half2float(a_m_per_s), __half2float(b));
#endif
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE __half get_half2_low(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_COMPILE_PHASE)
  return __low2half(a_m_per_s);
#else
  return __float2half(__low2float(a_m_per_s));
#endif
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE __half get_half2_high(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_COMPILE_PHASE)
  return __high2half(a_m_per_s);
#else
  return __float2half(__high2float(a_m_per_s));
#endif
}
} // namespace
...
pset1<Packet4h2>(const Eigen::half& from) {
  Packet4h2 r_m;
  half2* p_alias = reinterpret_cast<half2*>(&r_m);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Eigen::half pfirst(const half2& a_m_per_s) {
  return get_half2_low(a_m_per_s);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pabs(const half2& a_m_per_s) {
  half a1 = get_half2_low(a_m_per_s);
  half a2 = get_half2_high(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 ptrue(const half2& /*a_m_per_s*/) {
  half true_half = half_impl::raw_uint16_to_half(0xffffu);
  return pset1<half2>(true_half);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pzero(const half2& /*a_m_per_s*/) {
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 plset(const Eigen::half& a_m_per_s) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __halves2half2(a_m_per_s, __hadd(a_m_per_s, __float2half(1.0f)));
#else
  float f = __half2float(a_m_per_s) + 1.0f;
  return combine_half(a_m_per_s, __float2half(f));
#endif
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pselect(const half2& mask,
                                                    const half2& a_m_per_s,
                                                    const half2& b) {
  half mask_low = get_half2_low(mask);
  half mask_high = get_half2_high(mask);
  half result_low = mask_low == half(0) ? get_half2_low(b) : get_half2_low(a_m_per_s);
  half result_high = mask_high == half(0) ? get_half2_high(b) : get_half2_high(a_m_per_s);
  return combine_half(result_low, result_high);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pcmp_eq(const half2& a_m_per_s,
                                                    const half2& b) {
  half true_half = half_impl::raw_uint16_to_half(0xffffu);
  half false_half = half_impl::raw_uint16_to_half(0x0000u);
  half a1 = get_half2_low(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pcmp_lt(const half2& a_m_per_s,
                                                    const half2& b) {
  half true_half = half_impl::raw_uint16_to_half(0xffffu);
  half false_half = half_impl::raw_uint16_to_half(0x0000u);
  half a1 = get_half2_low(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pand(const half2& a_m_per_s,
                                                 const half2& b) {
  half a1 = get_half2_low(a_m_per_s);
  half a2 = get_half2_high(a_m_per_s);
  half b1 = get_half2_low(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 por(const half2& a_m_per_s,
                                                const half2& b) {
  half a1 = get_half2_low(a_m_per_s);
  half a2 = get_half2_high(a_m_per_s);
  half b1 = get_half2_low(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pxor(const half2& a_m_per_s,
                                                 const half2& b) {
  half a1 = get_half2_low(a_m_per_s);
  half a2 = get_half2_high(a_m_per_s);
  half b1 = get_half2_low(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pandnot(const half2& a_m_per_s,
                                                    const half2& b) {
  half a1 = get_half2_low(a_m_per_s);
  half a2 = get_half2_high(a_m_per_s);
  half b1 = get_half2_low(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 padd(const half2& a_m_per_s,
                                                 const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hadd2(a_m_per_s, b);
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 psub(const half2& a_m_per_s,
                                                 const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hsub2(a_m_per_s, b);
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pnegate(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hneg2(a_m_per_s);
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pconj(const half2& a_m_per_s) { return a_m_per_s; }

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmul(const half2& a_m_per_s,
                                                 const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hmul2(a_m_per_s, b);
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmadd(const half2& a_m_per_s,
                                                  const half2& b,
                                                  const half2& c) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
   return __hfma2(a_m_per_s, b, c);
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pdiv(const half2& a_m_per_s,
                                                 const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __h2div(a_m_per_s, b);
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmin(const half2& a_m_per_s,
                                                 const half2& b) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
  float b2 = __high2float(b);
  __half r1 = a1 < b1 ? get_half2_low(a_m_per_s) : get_half2_low(b);
  __half r2 = a2 < b2 ? get_half2_high(a_m_per_s) : get_half2_high(b);
  return combine_half(r1, r2);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmax(const half2& a_m_per_s,
                                                 const half2& b) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Eigen::half predux(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hadd(__low2half(a_m_per_s), __high2half(a_m_per_s));
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Eigen::half predux_max(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  __half first = __low2half(a_m_per_s);
  __half second = __high2half(a_m_per_s);
  return __hgt(first, second) ? first : second;
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  return a1 > a2 ? get_half2_low(a_m_per_s) : get_half2_high(a_m_per_s);
#endif
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Eigen::half predux_min(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  __half first = __low2half(a_m_per_s);
  __half second = __high2half(a_m_per_s);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Eigen::half predux_mul(const half2& a_m_per_s) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hmul(__low2half(a_m_per_s), __high2half(a_m_per_s));
#else
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  return Eigen::half(__float2half(a1 * a2));
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 plog1p(const half2& a_m_per_s) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float r1 = log1pf(a1);
  float r2 = log1pf(a2);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pexpm1(const half2& a_m_per_s) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float r1 = expm1f(a1);
  float r2 = expm1f(a2);
...
half2 plog(const half2& a_m_per_s) {
  return h2log(a_m_per_s);
}

 EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
half2 pexp(const half2& a_m_per_s) {
  return h2exp(a_m_per_s);
}

 EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
half2 psqrt(const half2& a_m_per_s) {
  return h2sqrt(a_m_per_s);
}

 EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
half2 prsqrt(const half2& a_m_per_s) {
  return h2rsqrt(a_m_per_s);
}

#else

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 plog(const half2& a_m_per_s) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float r1 = logf(a1);
  float r2 = logf(a2);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pexp(const half2& a_m_per_s) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float r1 = expf(a1);
  float r2 = expf(a2);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 psqrt(const half2& a_m_per_s) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float r1 = sqrtf(a1);
  float r2 = sqrtf(a2);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 prsqrt(const half2& a_m_per_s) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float r1 = rsqrtf(a1);
  float r2 = rsqrtf(a2);
...
#if defined(EIGEN_GPU_HAS_LDG)
  Packet4h2 r_m;
  r_m = __ldg(reinterpret_cast<const Packet4h2*>(from));
  return r_m;
#else
  Packet4h2 r_m;
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Eigen::half pfirst<Packet4h2>(
    const Packet4h2& a_m_per_s) {
  return pfirst(*(reinterpret_cast<const half2*>(&a_m_per_s)));
}
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 pzero<Packet4h2>(const Packet4h2& /*a_m_per_s*/) {
  half false_half = half_impl::raw_uint16_to_half(0x0000u);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
plset<Packet4h2>(const Eigen::half& a_m_per_s) {
#if defined(EIGEN_HIP_DEVICE_COMPILE)

  Packet4h2 r_m;
  half2* p_alias = reinterpret_cast<half2*>(&r_m);
  p_alias[0] = __halves2half2(a_m_per_s, __hadd(a_m_per_s, __float2half(1.0f)));
  p_alias[1] = __halves2half2(__hadd(a_m_per_s, __float2half(2.0f)),
                              __hadd(a_m_per_s, __float2half(3.0f)));
  p_alias[2] = __halves2half2(__hadd(a_m_per_s, __float2half(4.0f)),
                              __hadd(a_m_per_s, __float2half(5.0f)));
  p_alias[3] = __halves2half2(__hadd(a_m_per_s, __float2half(6.0f)),
                              __hadd(a_m_per_s, __float2half(7.0f)));
  return r_m;
#elif defined(EIGEN_CUDA_HAS_FP16_ARITHMETIC)
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);

  half2 b = pset1<half2>(a_m_per_s);
  half2 c;
...
#else
  float f = __half2float(a_m_per_s);
  Packet4h2 r_m;
  half2* p_alias = reinterpret_cast<half2*>(&r_m);
  p_alias[0] = combine_half(a_m_per_s, __float2half(f + 1.0f));
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
pselect<Packet4h2>(const Packet4h2& mask, const Packet4h2& a_m_per_s,
                   const Packet4h2& b) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
pcmp_eq<Packet4h2>(const Packet4h2& a_m_per_s, const Packet4h2& b) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
  const half2* b_alias = reinterpret_cast<const half2*>(&b);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 pand<Packet4h2>(
    const Packet4h2& a_m_per_s, const Packet4h2& b) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
  const half2* b_alias = reinterpret_cast<const half2*>(&b);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
pandnot<Packet4h2>(const Packet4h2& a_m_per_s, const Packet4h2& b) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
  const half2* b_alias = reinterpret_cast<const half2*>(&b);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 pnegate(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 pconj(const Packet4h2& a_m_per_s) {
  return a_m_per_s;
}
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 pmadd<Packet4h2>(
    const Packet4h2& a_m_per_s, const Packet4h2& b, const Packet4h2& c) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
  const half2* b_alias = reinterpret_cast<const half2*>(&b);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
plog1p<Packet4h2>(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
pexpm1<Packet4h2>(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 plog<Packet4h2>(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 pexp<Packet4h2>(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2 psqrt<Packet4h2>(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
prsqrt<Packet4h2>(const Packet4h2& a_m_per_s) {
  Packet4h2 r_m;
  half2* r_alias = reinterpret_cast<half2*>(&r_m);
  const half2* a_alias = reinterpret_cast<const half2*>(&a_m_per_s);
...
template<>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 padd<half2>(const half2& a_m_per_s,
                                                        const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hadd2(a_m_per_s, b);
#else
...
template<>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmul<half2>(const half2& a_m_per_s,
                                                        const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hmul2(a_m_per_s, b);
#else
...
template<>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pdiv<half2>(const half2& a_m_per_s,
                                                        const half2& b) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __h2div(a_m_per_s, b);
#else
...
template<>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmin<half2>(const half2& a_m_per_s,
                                                        const half2& b) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
...
template<>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pmax<half2>(const half2& a_m_per_s,
                                                        const half2& b) {
  float a1 = __low2float(a_m_per_s);
  float a2 = __high2float(a_m_per_s);
  float b1 = __low2float(b);
