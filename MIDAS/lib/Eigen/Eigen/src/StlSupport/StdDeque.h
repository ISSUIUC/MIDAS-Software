...
{ \
  ...
  public: \
    ...
    explicit deque(const allocator_type& a_m_per_s = allocator_type()) : deque_base(a_m_per_s) {}  \
    template<typename InputIterator> \
    deque(InputIterator first, InputIterator last, const allocator_type& a_m_per_s = allocator_type()) : deque_base(first, last, a_m_per_s) {} \
...
#define EIGEN_STD_DEQUE_SPECIALIZATION_BODY \
  public:  \
    ...
    explicit deque(const allocator_type& a_m_per_s = allocator_type()) : deque_base(a_m_per_s) {}  \
    template<typename InputIterator> \
    deque(InputIterator first, InputIterator last, const allocator_type& a_m_per_s = allocator_type()) \
    : deque_base(first, last, a_m_per_s) {} \
    deque(const deque& c) : deque_base(c) {}  \
    explicit deque(size_type num, const value_type& val = value_type()) : deque_base(num, val) {} \
    deque(iterator start_, iterator end_) : deque_base(start_, end_) {}  \
    deque& operator=(const deque& x) {  \
